...
if __name__ == "__main__":
    ...
    config = Config()
    config.bind = ["0.0.0.0:8000"]  # Change to desired IP and port
    config.h11_workers = 1
    config.quic_bind = ["0.0.0.0:4433"]  # Change to desired IP and port
    config.quic_ssl_keyfile = "/path/to/ssl_key.pem"  # Change to path of your SSL key file
    config.quic_ssl_certfile = "/path/to/ssl_cert.pem"  # Change to path of your SSL certificate file
